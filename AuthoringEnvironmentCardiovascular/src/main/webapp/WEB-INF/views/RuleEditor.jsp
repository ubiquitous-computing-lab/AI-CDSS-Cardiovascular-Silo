...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="#"> <img src="${pageContext.request.contextPath}/resources/images/MMlogo.png" style="height:100px; float:left; margin-right:10px;" /> &nbsp;Expert-Driven Intelligent Knowledge Authoring Tool</a>
    ...
    <tr>
        ...
        <td>
           <form:select path="rule.RuleTypeID">
				  <form:option value="1">Diagnosis</form:option>
				  <form:option value="2">Treatment</form:option>
			</form:select>
        </td>
        <td align="right">
