   ...
   <script type="text/javascript">
			...
			$(document).ready(function() {
				var table= $('#rules').DataTable( {
					"ajax": "http://163.180.116.194:8081/AuthoringEnvironmentCardiovascular/rulesList",
					"columns": [
						
						{ "data": "ruleTitle" },
						{ "data": "specialistName" },
						{ "data": "institution" },
						{ "defaultContent": "<button class='editbtn' ><i class='icon-pencil'></i>&nbsp;&nbsp;Edit</button>&nbsp;&nbsp;&nbsp;&nbsp;<button class='deletebtn'><i class='icon-trash'></i>&nbsp;&nbsp;Delete</button>"}
						
					]
				} );
				
					 $('#rules tbody').on( 'click', '.editbtn', function () {
						 var data = table.row( $(this).parents('tr') ).data();
						 window.location.href="http://163.180.116.194:8081/AuthoringEnvironmentCardiovascular/edit/"+data.ruleID;
					    } );
					 
					 $('#rules tbody').on( 'click', '.deletebtn', function () {
						 var data = table.row( $(this).parents('tr') ).data();
						 window.location.href="http://163.180.116.194:8081/AuthoringEnvironmentCardiovascular/remove/"+data.ruleID;
					    } );
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.aspx" > <img src="<c:url value="resources/images/MMlogo.png" />" style="height:100px; float:left; margin-right:10px;" /> &nbsp;Expert-Driven Intelligent Knowledge Authoring Tool</a>
      <div class="nav-collapse">
        <ul class="nav pull-right"> 
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> Dr. Choi <b class="caret"></b></a>
            <ul class="dropdown-menu">
...
<table id="rules" class="display" cellspacing="0" width="100%">
       <thead>
            <tr>
                <th>Rule Title</th>
...
<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; 2017. Intelligent Knowledge Authoring Tool.</div>
        <!-- /span12 --> 
      </div>
      <!-- /row --> 
    </div>
