app.controller('patientListingCtrl', function($scope, $rootScope, $http, $routeParams, $timeout, $location, patientService) {

  $scope.MRN = $routeParams.MRN;
  console.log('MRN: '+$scope.MRN);

  $scope.loadPatient = function(){

    $rootScope.isPageLoading = true;
    patientService.getPatients($scope.MRN).then(function(res){
      $scope.patients = res;

      console.log(' in loadPatient: ');
      console.log(res)
  ...
  $scope.deletePatient = function(patientId, patientMRN){

    if(confirm('Are you sure to delete "' + patientMRN + '" patient ? ')) {
      $rootScope.isPageLoading = true;
      patientService.deletePatient(patientId).then(function(res){
        $scope.loadPatient()
      },function(err){
        console.log('error in patient deletion');
        $rootScope.hideLoader();
        console.log(JSON.stringify(err));
      });     
    }
